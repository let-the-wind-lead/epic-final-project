...
// Auth0 config — using your fixed credentials
const config = {
  authRequired: false,
  auth0Logout: true,
  secret: 'auth0-secret',  // You had this in your docker-compose.yml
...
// PostgreSQL config — matching docker-compose
const pool = new Pool({
